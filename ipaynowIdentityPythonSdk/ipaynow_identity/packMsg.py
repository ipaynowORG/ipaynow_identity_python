...
from ipaynowIdentityPythonSdk.ipaynow_identity.desUtil import base64Encryt, md5Encrypt, desEncrypt
try:
...
class PackMsgSend:
    ...
    def getResultString(self):
        ...
        print("第二部分明文：" + self.__3desKsy,self.__fromStrMd5)
        ...
        print("第三部分明文：" + self.__fromStrMd5 + "&" + self.__md5Key)
