...
from ipaynowIdentityPythonSdk.ipaynow_identity import VERSION
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'ipaynow_identity'))

setup(
    name='ipaynow_identity',
    cmdclass={'build_py': build_py},
    version=VERSION,
    description='ipaynow_identity python bindings',
    author='ipaynow',
    author_email='www.ipaynow.com',
    url='https://pay.ipaynow.cn/',
    packages=['ipaynow_identity'],
    classifiers=[
